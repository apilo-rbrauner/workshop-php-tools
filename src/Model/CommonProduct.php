...
class CommonProduct implements ProductInterface
{
    private string $name = '';
    ...
    {
        return "[COMMON PRODUCT|id: {$this->getId()}, name: {$this->getName()}, description: {$this->getDescription()}, price: {$this->getPrice()}]";
    }
}
